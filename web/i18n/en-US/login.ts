const translation = {
  ...
  licenseExpiredTip: 'The Enterprise license for your workspace has expired. Please contact your administrator to continue using the platform.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect license server. Please contact your administrator to continue using the platform.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Enterprise license for your workspace is inactive. Please contact your administrator to continue using the platform.',
  webapp: {
    login: 'Login',
